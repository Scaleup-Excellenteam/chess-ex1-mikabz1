...
/// @brief Outputs a human-readable representation of a move, using the flipped coordinates.
/// @param os The output stream to write to.
/// @param mv The move to print, containing source and destination coordinates.
/// @return The output stream after writing the move.
