...
public:
    ...
    // Executes a move by placing the specified piece at the destination coordinate.
    // This function assumes the move is already validated as legal.
    void makeMove(const Coordinate & destination,const std::shared_ptr<Piece>& piece);
private:
